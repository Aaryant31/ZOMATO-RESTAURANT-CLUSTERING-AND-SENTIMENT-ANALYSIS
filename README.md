...
## Problem Statement
Your task is to cluster the zomato restaurants into different segments. Also the data has valuable information around cuisine and costing which can be used in cost vs. benefit analysis Perform sentiment analysis. Also use metadata of reviewers to identifying the critics in the industry.
